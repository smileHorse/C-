...
const int dbDefaultPollInterval = 1*1000; // milliseconds  10*1000
const int dbOpenPollInterval = 1000; // milliseconds
const int dbWaitReadyTimeout = 2*1000; // milliseconds  60*1000
const int dbWaitStatusTimeout = 2*1000; // milliseconds   60*1000
const int dbRecoveryConnectionAttempts = 3; 
const int dbStartupConnectionAttempts = 2;//60
const int dbReplicationWriteTimeout =2*1000 ; // milliseconds 60*1000
