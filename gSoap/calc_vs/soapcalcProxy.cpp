...
calcProxy::calcProxy(struct soap *_soap, const char *endpoint)
{	this->soap = _soap;
	this->soap_own = false;
	calcProxy_init(_soap->imode, _soap->omode);
...
calcProxy::calcProxy(const char *endpoint)
{	this->soap = soap_new();
	this->soap_own = true;
	calcProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
...
calcProxy::calcProxy(const char *endpoint, soap_mode iomode)
{	this->soap = soap_new();
	this->soap_own = true;
	calcProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
